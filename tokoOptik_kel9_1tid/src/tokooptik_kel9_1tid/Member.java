...
public class Member extends javax.swing.JFrame {
    ...
    editMember data = new editMember();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Member", "Nama Member", "Email Member", "No HP Member"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        email = jTable1.getValueAt(baris, 2).toString();
        ...
        data.jTextField2.setText(email);
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        // TODO add your handling code here:
        try {
            InputStream is = Member.class.getResourceAsStream("/laporan/reportmember.jasper");
    ...
    private void cariData(String key){
        try{
            Object[] judul_kolom = {"Kode Member", "Nama Member", "Alamat Member", "No HP Member"};
            ...
            res=stt.executeQuery("SELECT * from member WHERE id_member LIKE '%"+key+"%' OR nama_member LIKE '%"+key+"%' OR email LIKE '%"+key+"%'");  
            while(res.next()){
                Object[] data={
                    res.getString("id_member"),
                    res.getString("nama_member"),
                    res.getString("email"),
                    res.getString("no_hp_member")       
                };
               model.addRow(data);
            }                
        } catch (Exception ex) {
