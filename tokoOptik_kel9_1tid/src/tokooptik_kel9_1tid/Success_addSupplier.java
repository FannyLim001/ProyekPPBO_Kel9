 ...
 * @author FANNY
 */
public class Success_addSupplier extends javax.swing.JFrame {

    /**
     * Creates new form login_page
     */
    public Success_addSupplier() {
        initComponents();
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        addSupplier am = new addSupplier();
        am.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Success_addSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new Success_addSupplier().setVisible(true);
//            }
//        });
    }
