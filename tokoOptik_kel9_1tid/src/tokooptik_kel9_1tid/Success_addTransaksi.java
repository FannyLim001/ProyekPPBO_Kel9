 ...
 * @author FANNY
 */
public class Success_addTransaksi extends javax.swing.JFrame {

    /**
     * Creates new form login_page
     */
    public Success_addTransaksi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Data berhasil ditambahkan !");
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        addTransaksi am = new addTransaksi();
        am.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Success_addTransaksi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Success_addTransaksi().setVisible(true);
            }
        });
    }
