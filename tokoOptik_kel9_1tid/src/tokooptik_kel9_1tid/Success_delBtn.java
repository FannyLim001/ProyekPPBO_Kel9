 ...
 * @author FANNY
 */
public class Success_delBtn extends javax.swing.JFrame {

    /**
     * Creates new form login_page
     */
    public Success_delBtn() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Success_delBtn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Success_delBtn().setVisible(true);
            }
        });
    }
