 ...
 * @author FANNY
 */
public class Success_delSupplier extends javax.swing.JFrame {

    /**
     * Creates new form login_page
     */
    public Success_delSupplier() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Data berhasil dihapus !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Success_delSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Success_delSupplier().setVisible(true);
            }
        });
    }
