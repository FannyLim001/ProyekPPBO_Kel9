 ...
 * @author FANNY
 */
public class Success_editProduk extends javax.swing.JFrame {

    /**
     * Creates new form login_page
     */
    public Success_editProduk() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Success_editProduk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Success_editProduk().setVisible(true);
            }
        });
    }
